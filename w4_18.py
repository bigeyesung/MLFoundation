...
if __name__ == "__main__":
    ...
    # Q18
    # optimal_lambda_Eval_min: from previous result
    w_reg = sol.calculate_w_reg(train_x, train_y, pow(10, optimal_lambda_Eval_min))
    optimal_Ein = sol.calculate_E(w_reg, train_x, train_y)
    optimal_Eout = sol.calculate_E(w_reg, test_x, test_y)
